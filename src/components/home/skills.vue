        ...
        >
                ...
                <div class="p-6 w-full h-72 md:h-[26rem] bg-white rounded-lg">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <div class="badge badge-outline text-black">
                            <img alt="Javascript" class="h-5 w-5" src="../../assets/icons/js.svg" />
                            Javascript
                        </div>
                        <div class="badge badge-outline text-black">
                            <img alt="HTML" class="h-5 w-5" src="../../assets/icons/html.svg" />
                            HTML
                        </div>
                        <div class="badge badge-outline text-black">
                            <img alt="CSS" class="h-5 w-5" src="../../assets/icons/css.svg" />CSS
                        </div>
                        <div class="badge badge-outline text-black">
                            <img alt="Vue.js" class="h-5 w-5" src="../../assets/icons/vue.svg" />Vue
                            js
                        </div>
                    </div>
                </div>
            ...
            <div class="col-span-3 md:col-span-1">
                <div class="p-6 w-full h-72 md:h-[26rem] bg-white rounded-lg">
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <div class="badge badge-outline text-black">
                            <img alt="Java" class="h-5 w-5" src="../../assets/icons/java.svg" />Java
                        </div>
                        <div class="badge badge-outline text-black">
                            <img alt="C++" class="h-5 w-5" src="../../assets/icons/c++.svg" />C++
                        </div>
                        <div class="badge badge-outline text-black">
                            <img
                                alt="csharp"
            ...
            <div class="col-span-3 md:col-span-1 row-span-1 md:row-start-2 md:row-end-3 rounded-lg">
                <div class="p-6 w-full h-72 md:h-[26rem] bg-white rounded-lg">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <div class="badge badge-outline text-black">
                            <img alt="Jira" class="h-5 w-5" src="../../assets/icons/jira.svg" />Jira
                        </div>
                        <div class="badge badge-outline text-black">
                            <img alt="Git" class="h-5 w-5" src="../../assets/icons/git.svg" />Git
                        </div>
                        <div class="badge badge-outline text-black">
                            <img alt="Bash" class="h-5 w-5" src="../../assets/icons/bash.svg" />Bash
                        </div>
                        <div class="badge badge-outline text-black">
                            <img
                                alt="Github"
